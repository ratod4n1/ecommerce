...
<head>
  ...
  <!--[if lt IE 9]>
  <script src="/res/admin/res/admin/res/adminhttps://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="/res/admin/res/admin/res/adminhttps://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
</head>
<!--
BODY TAG OPTIONS:
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="/res/admin/res/adminindex2.html" class="logo">
